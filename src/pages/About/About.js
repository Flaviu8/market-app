...
const About = () => {
   ...
   return (
     <div className="about-container">
        <h4>About Our Market</h4>
        <img src="https://static.wixstatic.com/media/ad420a_669665f5ac454bf29853afbc02b635df~mv2.jpg/v1/fill/w_600,h_400,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/GettyImages-1128054012.jpg" alt="img"></img>
        <p>
                 I'm a paragraph. 
                Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your 
                own content and make changes to the font. Feel free to drag and drop me anywhere you like on your page. I’m a great place for you to tell a story and let your users know a little more about you. 
        </p> 
                <p>
